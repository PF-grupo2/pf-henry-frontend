...
const Product = () => {
  ...
  const handleFilter = () => {
    ...
    if (zapatilla && zapatilla.length > 0)
      formatFilters += `&search=${zapatilla}`;
    ...
    <div>
      <div className="container-fluid">
        <div className="row  justify-content-center align-items-center">
          <div className="col-lg-12 filtros">
            <div className="row ">
              ...
              <div className="col-lg-2  custom-select ">
                <label className="custom-label">Talla</label>
                <select
                  onChange={handleFilter}
                  ref={sizes}
              ...
              <div className="col-lg-2  custom-select">
                <label className="custom-label">Genero</label>
              ...
              <div className="col-lg-2  custom-select">
                <label className="custom-label">Estilo</label>
                <select
                  onChange={handleFilter}
                  ref={styles}
          ...
          <div className="col-lg-12 justify-content-center align-items-center">
            <div className="row">
              <div className="col-md-6">
                <ul className="list-inline shop-top-menu pb-3 pt-1"></ul>
              </div>
            </div>
          ...
          <div className="pagination justify-content-center align-items-center py-3 gap-2">
            <button
              className="rounded-circle bg-transparent d-flex justify-content-center align-items-center"
              style={{ width: "30px", height: "30px" }}
              onClick={handlePageChangeBack}
              disabled={page === 1 || allZapatillas.totalPages === 1}
            >
            ...
            <span className="fs-6">
              ...
              {allZapatillas?.currentPage} <span className="fw-bold"> de </span>
              {allZapatillas?.totalPages}
            </span>
            ...
            <button
              ...
              disabled={
                !allZapatillas ||
                allZapatillas.currentPage === allZapatillas.totalPages ||
                allZapatillas.totalPages === 1
              }
            >
