...
const RegisterForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://pf-henry-backend-agsr.onrender.com/api/v1/users/register', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className='container-register'>
      ...
      <div className=' procesar-register'>
      <form onSubmit={handleSubmit}>
        ...
        <button className='btn btn-outline-dark mx-4' type="submit">Registrarse</button>
      </form>
