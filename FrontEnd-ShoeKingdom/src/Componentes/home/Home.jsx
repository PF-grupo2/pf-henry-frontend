    ...
    <>
      <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active fondo-slide1">
            <div class="container ">
              <div class="row p-5">
                <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                  <img class="img-fluid" src="./assets/img/slide1.png" alt="" />
                </div>
                <div class="col-lg-6 mb-0 d-flex align-items-center">
                  <div class="text-align-left align-self-center">
                    <h1 className="titulo text-primary"><b>Zapatillas</b></h1>
          ...
          <div class="carousel-item  fondo">
            <div class="container">
              <div class="row px-2">
                <div class="mx-auto col-md-8 col-lg-6 ">
                  {/* <img class="img-fluid" src="./assets/img/foto.png" alt="" /> */}
                </div>
                <div class="col-lg-5 mb-0 d-flex align-items-center px-5 order-lg-last">
                  <div>
                    <h1 class="titulo2"><b>Sale</b></h1>
